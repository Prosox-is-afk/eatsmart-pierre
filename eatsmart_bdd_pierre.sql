...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 24 sep. 2025 à 23:10
...
--
-- Base de données : `eatsmart_bdd_pierre`
--
CREATE DATABASE IF NOT EXISTS `eatsmart_bdd_pierre` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `eatsmart_bdd_pierre`;
...
(0, 'Anchois 23cm', 7.9000, 'sauce tomate premium, origan, huile d\'olive extra vierge, anchois, olive', 1),
...
(25, 'Chevre miel 23cm', 8.9000, 'sauce crème fraîche premium, mozzarella, chevre, miel, olive', 0),
(26, 'Chevre miel 33cm', 13.9000, 'sauce crème fraîche premium, mozzarella, chevre, miel, olive', 0),
